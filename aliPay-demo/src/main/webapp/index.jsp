...
<div id="main">
    ...
    <form name=tradequery action="${root}/qryOrder" method=post
          target="_blank">
        <div id="body2" class="tab-content" name="divcontent">
            <dl class="content">
                ...
                <dt>支付宝交易号 ：</dt>
                <dd>
                    <input id="relOrderNo" name="relOrderNo" />
                </dd>
                <hr class="one_line">
                <dt></dt>
                <dd id="btn-dd">
    ...
    <form name=traderefund action="${root}/refund" method=post
          target="_blank">
        <div id="body3" class="tab-content" name="divcontent">
            <dl class="content">
                ...
                <dt>退款金额 ：</dt>
                <dd>
                    <input id="refundAmt" name="refundAmt" />
                </dd>
                <hr class="one_line">
                <dt>退款原因 ：</dt>
                <dd>
                    <input id="refundReason" name="refundReason" />
                </dd>
                <hr class="one_line">
                <dt>退款请求号 ：</dt>
                <dd>
                    <input id="refundNo" name="refundNo" />
                </dd>
                <hr class="one_line">
                <dt></dt>
                <dd id="btn-dd">
    ...
    <form name=traderefundquery
          action="${root}/qryRefund" method=post
          target="_blank">
    ...
    <form name=tradeclose action="${root}/closeOrder" method=post
          target="_blank">
...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        document.getElementById("orderNo").value =  sNow;
        document.getElementById("orderSubject").value = "测试";
        document.getElementById("orderAmt").value = "0.01";
    }
    GetDateNow();
</script>
</html>