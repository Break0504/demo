...
def sendTaskLog():
    ...
    file = open(r'F:\tasklog.txt', mode='r', encoding='utf-8', newline='')
    lines = file.readlines()
    for line in lines:
        print(line.strip())
        txt_ctrl_v(line.strip())
        send_m(win)
